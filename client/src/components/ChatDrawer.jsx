          ...
          <div className="chat-input-row">
            {voice.isRecording ? (
              ...
              <form className="chat-composer" onSubmit={onSendChat}>
                {allowFiles && <FileUploadButton roomId={roomId} />}

                <div className="chat-emoji-wrapper" ref={emojiContainerRef}>
                  <button
                    type="button"
                    className="chat-icon-btn emoji-btn"
                ...
                {chatInput.trim() ? (
                  <button type="submit" className="chat-icon-btn send-btn" title="Send" aria-label="Send message">
                  ...
                  <button
                    type="button"
                    className="chat-icon-btn mic-btn"
